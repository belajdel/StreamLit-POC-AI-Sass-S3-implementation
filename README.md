...
└── /
    ...
    └── uploads
        ├── anglais.mp4
        ├── boring-meetings---30-seconds---learn-english-conversation.mp4
        ├── ert.mp4
        ├── hh.mp4
        ├── test.mp4
        └── zab.mp4
...
| File | Summary |
| --- | --- |
| [aa.py](aa.py) | <code>❯ REPLACE-ME</code> |
| [app.py](app.py) | <code>❯ REPLACE-ME</code> |
| [ex.py](ex.py) | <code>❯ REPLACE-ME</code> |
| [up.py](up.py) | <code>❯ REPLACE-ME</code> |
